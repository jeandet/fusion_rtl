...
class _SPIMaster(LiteXModule):
    def __init__(self, sys_clk_freq):
        ...
        self.submodules.serdes = serdes = _SERDES()
...
class SPI(LiteXModule):
    def __init__(self, sys_clk_freq, loopback=False):
        ...
        self.submodules._spi = _SPIMaster(sys_clk_freq)
...
if __name__ == "__main__":
    ...
    convert(SPI(sys_clk_freq=60e6, loopback=False)).write("SPI.v")